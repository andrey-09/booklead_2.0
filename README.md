...
Доступна ещё маленькая доработка с хостингом, пишите лично, все скину; просто не хотел в открытый доступ кидать)
...
options:
  ...
  --max_size 100      Максимальный размер папки с загрузками в ГБ
```
Книга будет скачана в папку с названием url, а не с названием книги (т.к. url уникально определяют файл, а название нет), там будут все изображения. Если хотите, чтоб было с названием книги, надо всего одну строку в коде изменить, думаю сами найдете)

### Детальнее про параметры:
